# Fix Ollama Download Format (.tgz -> .tar.zst)
...
See [GitHub Actions Container Builds](github-actions-container-builds.md) for full incident details and lessons learned.
